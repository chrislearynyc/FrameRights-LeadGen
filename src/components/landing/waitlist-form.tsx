        ...
        return (
            <div className="w-full max-w-md mx-auto text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="p-6 bg-green-50 rounded-lg border border-green-100">
                    <h3 className="text-xl font-medium text-green-900 mb-2">{successMessage}</h3>
                ...
                <AnimatePresence>
                    {showFollowUp && (
                        ...
                        >
                            <p className="text-sm font-medium text-slate-600 text-center">Quick question: What kind of photography do you license most?</p>
                            ...
                            {showOtherInput && (
                                ...
                                >
                                    <h4 className="text-sm font-medium text-slate-700 mb-3">What kind of photography?</h4>
                                    <div className="flex w-full gap-2">
                                        ...
                                        />
                                        <Button size="sm" onClick={submitOther} disabled={!otherValue.trim()}>
                                            Save
                                        </Button>
                                    </div>
                                    <button
                            ...
                            {!showOtherInput && (
                                <button onClick={() => setShowFollowUp(false)} className="text-xs text-slate-400 underline w-full text-center hover:text-slate-600">Skip</button>
                            )}
                        </motion.div>
                    )}
                </AnimatePresence>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full max-w-sm mx-auto">
            ...
            <div className="space-y-2">
                <label className="text-sm text-slate-600 font-medium pl-1">
                    Main reason? <span className="text-slate-400 font-normal">(optional)</span>
                </label>
