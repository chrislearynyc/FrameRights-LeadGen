  ...
  return (
    <section className="relative px-6 pt-32 pb-20 md:pt-48 md:pb-32 max-w-5xl mx-auto text-center">
      ...
      <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
        FrameRights helps photographers keep a simple, shareable record of who
        is licensed to use an image, for what use, and under what terms—readable
        without login, printable, and easy to reference.
      </p>
