    ...
    const steps = [
        {
            ...
            description: "Define who, what, where, and the term. Use clear language, not legalese."
        },
        {
            title: "Attach it to image(s)",
            description: "Upload low-res references or link to a gallery. Generate a unique ID."
        },
        {
            title: "Share the clean public record",
            description: "Send a professional link that shows license status clearly. No login required for them."
        }
    ];
    ...
    return (
        <section id="how-it-works" className="px-6 py-20 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {steps.map((step, i) => (
                    <div key={i} className="bg-white p-6 rounded-2xl border border-slate-100 hover:border-slate-200 transition-colors">
